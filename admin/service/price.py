...
from models.price import Currency, Price
...
class PriceClass:
    ...
    def set_price(self, price_dict: dict, admin_id: str):
    ...
    def get_active_subscribtion(self) -> list:
    ...
    def get_arhive_subscribtion(self) -> list:
